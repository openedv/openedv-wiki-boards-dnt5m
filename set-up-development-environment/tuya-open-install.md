...
- Python v3.8.0 或更高版本：[下载地址](./software/python-3.8.10-amd64.exe)
- Git v2.0.0 或更高版本：[下载地址](./software/Git-2.51.0-64-bit.exe)
- Make v3.0 或更高版本：[下载地址](./software/make-3.81.exe)
